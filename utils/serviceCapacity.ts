...
import { getServiceCapacity as SEQServCap, ensureServiceCapacityData as SEQEnsCapData } from "../region-specific/SEQ/serviceCapacity.js";
...
export function getServiceCapacity(
    ...
    switch (TRAX_CONFIG.region) {
        case "SEQ": return SEQServCap(inst, stopTime, dateStr, _dirOverride);
        case "none":
        default:
            return "unknown";
    }

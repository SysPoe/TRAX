export let SRT_DATA = [
    ...
    { from: "Wulkuraka", to: "Karrabin", travelTrain: 3 },
    // Mount Isa
    { from: "Townsville Jetty", to: "Stuart", travelTrain: 28 },
    { from: "Stuart", to: "Townsville Jetty", travelTrain: 24 },
    { from: "Stuart", to: "Antill Plains", travelTrain: 18 },
    { from: "Antill Plains", to: "Stuart", travelTrain: 15 },
    { from: "Antill Plains", to: "Woodstock", travelTrain: 22 },
    { from: "Woodstock", to: "Antill Plains", travelTrain: 18 },
    { from: "Woodstock", to: "Reid River", travelTrain: 21 },
    { from: "Reid River", to: "Woodstock", travelTrain: 22 },
    { from: "Reid River", to: "Woldston", travelTrain: 14 },
    { from: "Woldston", to: "Reid River", travelTrain: 13 },
    { from: "Woldston", to: "Mingela", travelTrain: 41 },
    { from: "Mingela", to: "Woldston", travelTrain: 29 },
    { from: "Mingela", to: "Sellheim", travelTrain: 34 },
    { from: "Sellheim", to: "Mingela", travelTrain: 37 },
    { from: "Sellheim", to: "Ch. Towers", travelTrain: 30 },
    { from: "Ch. Towers", to: "Sellheim", travelTrain: 27 },
    { from: "Ch. Towers", to: "Southern Cross", travelTrain: 25 },
    { from: "Southern Cross", to: "Ch. Towers", travelTrain: 25 },
    { from: "Sellheim", to: "Charters Towers", travelTrain: 30 }, // ADDED
    { from: "Charters Towers", to: "Sellheim", travelTrain: 27 }, // ADDED
    { from: "Charters Towers", to: "Southern Cross", travelTrain: 25 }, // ADDED
    { from: "Southern Cross", to: "Charters Towers", travelTrain: 25 }, // ADDED
    { from: "Southern Cross", to: "Balfes Ck", travelTrain: 26 },
    { from: "Balfes Ck", to: "Southern Cross", travelTrain: 28 },
    { from: "Balfes Ck", to: "Mungunburra", travelTrain: 21 },
    { from: "Mungunburra", to: "Balfes Ck", travelTrain: 21 },
    { from: "Mungunburra", to: "Thalanga", travelTrain: 9 },
    { from: "Thalanga", to: "Mungunburra", travelTrain: 7 },
    { from: "Thalanga", to: "Homestead", travelTrain: 16 },
    { from: "Homestead", to: "Thalanga", travelTrain: 13 },
    { from: "Homestead", to: "Pentland", travelTrain: 42 },
    { from: "Pentland", to: "Homestead", travelTrain: 40 },
    { from: "Pentland", to: "Warrigal", travelTrain: 24 },
    { from: "Warrigal", to: "Pentland", travelTrain: 28 },
    { from: "Warrigal", to: "Burra", travelTrain: 25 },
    { from: "Burra", to: "Warrigal", travelTrain: 18 },
    { from: "Burra", to: "Torrens Ck", travelTrain: 21 },
    { from: "Torrens Ck", to: "Burra", travelTrain: 25 },
    { from: "Torrens Ck", to: "Warreah", travelTrain: 25 },
    { from: "Warreah", to: "Torrens Ck", travelTrain: 23 },
    { from: "Burra", to: "Torrens Creek", travelTrain: 21 }, // ADDED
    { from: "Torrens Creek", to: "Burra", travelTrain: 25 }, // ADDED
    { from: "Torrens Creek", to: "Warreah", travelTrain: 25 }, // ADDED
    { from: "Warreah", to: "Torrens Creek", travelTrain: 23 }, // ADDED
    { from: "Warreah", to: "Prairie", travelTrain: 25 },
    { from: "Prairie", to: "Warreah", travelTrain: 23 },
    { from: "Prairie", to: "Tindo", travelTrain: 25 },
    { from: "Tindo", to: "Prairie", travelTrain: 27 },
    { from: "Tindo", to: "Hughenden", travelTrain: 43 },
    { from: "Hughenden", to: "Tindo", travelTrain: 39 },
    { from: "Hughenden", to: "Boree", travelTrain: 33 },
    { from: "Boree", to: "Hughenden", travelTrain: 37 },
    { from: "Boree", to: "Mumu", travelTrain: 33 },
    { from: "Mumu", to: "Boree", travelTrain: 35 },
    { from: "Mumu", to: "Marathon", travelTrain: 36 },
    { from: "Marathon", to: "Mumu", travelTrain: 30 },
    { from: "Marathon", to: "Barabon", travelTrain: 21 },
    { from: "Barabon", to: "Marathon", travelTrain: 19 },
    { from: "Barabon", to: "Moselle", travelTrain: 18 },
    { from: "Moselle", to: "Barabon", travelTrain: 17 },
    { from: "Moselle", to: "Richmond", travelTrain: 29 },
    { from: "Richmond", to: "Moselle", travelTrain: 47 },
    { from: "Richmond", to: "Gemoka", travelTrain: 35 },
    { from: "Gemoka", to: "Richmond", travelTrain: 36 },
    { from: "Gemoka", to: "Maxwelton", travelTrain: 34 },
    { from: "Maxwelton", to: "Gemoka", travelTrain: 33 },
    { from: "Maxwelton", to: "Nonda", travelTrain: 28 },
    { from: "Nonda", to: "Maxwelton", travelTrain: 26 },
    { from: "Nonda", to: "Nelia", travelTrain: 40 },
    { from: "Nelia", to: "Nonda", travelTrain: 46 },
    { from: "Nelia", to: "Quarrells", travelTrain: 32 },
    { from: "Quarrells", to: "Nelia", travelTrain: 29 },
    { from: "Quarrells", to: "Julia Ck", travelTrain: 34 },
    { from: "Julia Ck", to: "Quarrells", travelTrain: 31 },
    { from: "Julia Ck", to: "Gilliat", travelTrain: 39 },
    { from: "Gilliat", to: "Julia Ck", travelTrain: 39 },
    { from: "Quarrells", to: "Julia Creek", travelTrain: 34 }, // ADDED
    { from: "Julia Creek", to: "Quarrells", travelTrain: 31 }, // ADDED
    { from: "Julia Creek", to: "Gilliat", travelTrain: 39 }, // ADDED
    { from: "Gilliat", to: "Julia Creek", travelTrain: 39 }, // ADDED
    { from: "Gilliat", to: "Tibarri", travelTrain: 28 },
    { from: "Tibarri", to: "Gilliat", travelTrain: 26 },
    { from: "Tibarri", to: "Oorindi", travelTrain: 31 },
    { from: "Oorindi", to: "Tibarri", travelTrain: 30 },
    { from: "Oorindi", to: "Undina", travelTrain: 22 },
    { from: "Undina", to: "Oorindi", travelTrain: 19 },
    { from: "Undina", to: "Pymurra", travelTrain: 23 },
    { from: "Pymurra", to: "Undina", travelTrain: 21 },
    { from: "Pymurra", to: "Cannington Jcn", travelTrain: 14 },
    { from: "Cannington Jcn", to: "Pymurra", travelTrain: 13 },
    { from: "Cannington Jcn", to: "Oonoomurra", travelTrain: 7 },
    { from: "Oonoomurra", to: "Cannington Jcn", travelTrain: 6 },
    { from: "Oonoomurra", to: "Cloncurry", travelTrain: 25 },
    { from: "Cloncurry", to: "Oonoomurra", travelTrain: 21 },
    { from: "Cloncurry", to: "Marimo", travelTrain: 24 },
    { from: "Marimo", to: "Cloncurry", travelTrain: 26 },
    { from: "Marimo", to: "Malbon", travelTrain: 45 },
    { from: "Malbon", to: "Marimo", travelTrain: 44 },
    { from: "Malbon", to: "Wammutta", travelTrain: 27 },
    { from: "Wammutta", to: "Malbon", travelTrain: 29 },
    { from: "Wammutta", to: "Bungalien", travelTrain: 31 },
    { from: "Bungalien", to: "Wammutta", travelTrain: 31 },
    { from: "Bungalien", to: "Flynn", travelTrain: 11 },
    { from: "Flynn", to: "Bungalien", travelTrain: 10 },
    { from: "Flynn", to: "Duchess", travelTrain: 16 },
    { from: "Duchess", to: "Flynn", travelTrain: 12 },
    { from: "Duchess", to: "Woonigan", travelTrain: 36 },
    { from: "Woonigan", to: "Duchess", travelTrain: 34 },
    { from: "Woonigan", to: "Rifle Ck", travelTrain: 42 },
    { from: "Rifle Ck", to: "Woonigan", travelTrain: 41 },
    { from: "Rifle Ck", to: "Mt Isa", travelTrain: 44 },
    { from: "Mt Isa", to: "Rifle Ck", travelTrain: 38 },
    { from: "Rifle Ck", to: "Mount Isa", travelTrain: 44 }, // ADDED
    { from: "Mount Isa", to: "Rifle Ck", travelTrain: 38 }, // ADDED
    // Tablelands
    { from: "Cairns", to: "Edgehill", travelTrain: 11.5 },
    { from: "Edgehill", to: "Freshwater", travelTrain: 12.5 },
    { from: "Freshwater", to: "Redlynch", travelTrain: 4.5 },
    { from: "Redlynch", to: "Stoney Creek", travelTrain: 29.5 },
    { from: "Stoney Creek", to: "Barron Falls", travelTrain: 26.5 },
    { from: "Barron Falls", to: "Kuranda", travelTrain: 3.5 },
    { from: "Kuranda", to: "Koah", travelTrain: 27.5 },
    { from: "Koah", to: "Bibhoohra", travelTrain: 16.5 },
    { from: "Bibhoohra", to: "Mareeba", travelTrain: 16.5 },
    { from: "Mareeba", to: "Arriga Junction", travelTrain: 28.5 },
    { from: "Arriga Junction", to: "Dimbulah", travelTrain: 31.5 },
    { from: "Dimbulah", to: "Verdue", travelTrain: 41.5 },
    { from: "Verdue", to: "Lappa", travelTrain: 41.5 },
    { from: "Lappa", to: "Almaden", travelTrain: 63.5 },
    { from: "Almaden", to: "Gelaro", travelTrain: 29.5 },
    { from: "Gelaro", to: "Bullock Creek", travelTrain: 31.5 },
    { from: "Bullock Creek", to: "Lyndbrook", travelTrain: 31.5 },
    { from: "Lyndbrook", to: "Frewhurst", travelTrain: 31.5 },
    { from: "Frewhurst", to: "Mt Surprise", travelTrain: 30.5 },
    { from: "Mt Surprise", to: "Einasleigh", travelTrain: 163.5 },
    { from: "Einasleigh", to: "Forsayth", travelTrain: 178.5 },
    { to: "Cairns", from: "Edgehill", travelTrain: 10.5 },
    { to: "Edgehill", from: "Freshwater", travelTrain: 12.5 },
    { to: "Freshwater", from: "Redlynch", travelTrain: 4.5 },
    { to: "Redlynch", from: "Stoney Creek", travelTrain: 27.5 },
    { to: "Stoney Creek", from: "Barron Falls", travelTrain: 24.5 },
    { to: "Barron Falls", from: "Kuranda", travelTrain: 3.5 },
    { to: "Kuranda", from: "Koah", travelTrain: 27.5 },
    { to: "Koah", from: "Bibhoohra", travelTrain: 16.5 },
    { to: "Bibhoohra", from: "Mareeba", travelTrain: 16.5 },
    { to: "Mareeba", from: "Arriga Junction", travelTrain: 28.5 },
    { to: "Arriga Junction", from: "Dimbulah", travelTrain: 31.5 },
    { to: "Dimbulah", from: "Verdue", travelTrain: 41.5 },
    { to: "Verdue", from: "Lappa", travelTrain: 41.5 },
    { to: "Lappa", from: "Almaden", travelTrain: 61.5 },
    { to: "Almaden", from: "Gelaro", travelTrain: 45.5 },
    { to: "Gelaro", from: "Bullock Creek", travelTrain: 41.5 },
    { to: "Bullock Creek", from: "Lyndbrook", travelTrain: 41.5 },
    { to: "Lyndbrook", from: "Frewhurst", travelTrain: 41.5 },
    { to: "Frewhurst", from: "Mt Surprise", travelTrain: 44.5 },
    { to: "Mt Surprise", from: "Einasleigh", travelTrain: 103.5 },
    { to: "Einasleigh", from: "Forsayth", travelTrain: 163.5 },
    // Western System
    { from: "Columboola", to: "Miles", travelTrain: 23.5 },
    { from: "Miles", to: "Columboola", travelTrain: 23.5 },
    { from: "Chinchilla", to: "Brigalow", travelTrain: 27.5 },
    { from: "Brigalow", to: "Chinchilla", travelTrain: 27.5 },
    { from: "Brigalow", to: "Warra", travelTrain: 22.5 },
    { from: "Warra", to: "Brigalow", travelTrain: 22.5 },
    { from: "Warra", to: "Macalister", travelTrain: 22.5 },
    { from: "Macalister", to: "Warra", travelTrain: 22.5 },
    { from: "Macalister", to: "Baning", travelTrain: 17.5 },
    { from: "Baning", to: "Macalister", travelTrain: 17.5 },
    { from: "Baning", to: "Tycanba", travelTrain: 12.5 },
    { from: "Tycanba", to: "Baning", travelTrain: 12.5 },
    { from: "Coongoola", to: "Wyandra", travelTrain: 1 },
    { from: "Wyandra", to: "Coongoola", travelTrain: 1 },
    { from: "Cooladdi", to: "Cheepie", travelTrain: 72.5 },
    { from: "Cheepie", to: "Cooladdi", travelTrain: 72.5 },
    { from: "Cheepie", to: "Coolbinga", travelTrain: 67.5 },
    { from: "Coolbinga", to: "Cheepie", travelTrain: 67.5 },
    { from: "Coolbinga", to: "Quilpie", travelTrain: 57.5 },
    { from: "Quilpie", to: "Coolbinga", travelTrain: 57.5 },
    { from: "Cooladdi", to: "Coothalla", travelTrain: 52.5 },
    { from: "Coothalla", to: "Cooladdi", travelTrain: 52.5 },
    { from: "Coothalla", to: "Wanko", travelTrain: 27.5 },
    { from: "Wanko", to: "Coothalla", travelTrain: 27.5 },
    { from: "Wanko", to: "Westgate", travelTrain: 52.5 },
    { from: "Westgate", to: "Wanko", travelTrain: 52.5 },
    { from: "Cunnamulla", to: "Coongoola", travelTrain: 1 },
    { from: "Coongoola", to: "Cunnamulla", travelTrain: 1 },
    { from: "Coongoola", to: "Offham", travelTrain: 1 },
    { from: "Offham", to: "Coongoola", travelTrain: 1 },
    { from: "OFF", to: "WYR", travelTrain: 1 },
    { from: "WYR", to: "OFF", travelTrain: 1 },
    { from: "Dalby", to: "Kupunn", travelTrain: 1 },
    { from: "Kupunn", to: "Dalby", travelTrain: 1 },
    { from: "Kupunn", to: "Kumbarilla", travelTrain: 1 },
    { from: "Kumbarilla", to: "Kupunn", travelTrain: 1 },
    { from: "Kumbarilla", to: "Tara", travelTrain: 1 },
    { from: "Tara", to: "Kumbarilla", travelTrain: 1 },
    { from: "Tara", to: "The Gums", travelTrain: 1 },
    { from: "The Gums", to: "Tara", travelTrain: 1 },
    { from: "The Gums", to: "Meandarra", travelTrain: 1 },
    { from: "Meandarra", to: "The Gums", travelTrain: 1 },
    { from: "Meandarra", to: "Glennmorgan", travelTrain: 1 },
    { from: "Glennmorgan", to: "Meandarra", travelTrain: 1 },
    { from: "Dalby", to: "Blaxland", travelTrain: 9.5 },
    { from: "Blaxland", to: "Dalby", travelTrain: 9.5 },
    { from: "Blaxland", to: "Koomi", travelTrain: 15.5 },
    { from: "Koomi", to: "Blaxland", travelTrain: 15.5 },
    { from: "Koomi", to: "Bowenville", travelTrain: 17.5 },
    { from: "Bowenville", to: "Koomi", travelTrain: 17.5 },
    { from: "Bowenville", to: "Malu", travelTrain: 12.5 },
    { from: "Malu", to: "Bowenville", travelTrain: 12.5 },
    { from: "Malu", to: "Jordaryan Coal Siding", travelTrain: 7.5 },
    { from: "Jordaryan Coal Siding", to: "Malu", travelTrain: 7.5 },
    { from: "Jordaryan Coal Siding", to: "Oakey", travelTrain: 22.5 },
    { from: "Oakey", to: "Jordaryan Coal Siding", travelTrain: 22.5 },
    { from: "Dalby", to: "Tycanba", travelTrain: 7.5 },
    { from: "Tycanba", to: "Dalby", travelTrain: 7.5 },
    { from: "Glennmorgan", to: "Meandarra", travelTrain: 1 },
    { from: "Meandarra", to: "Glennmorgan", travelTrain: 1 },
    { from: "Meandarra", to: "The Gums", travelTrain: 1 },
    { from: "The Gums", to: "Meandarra", travelTrain: 1 },
    ...
    { from: "Kupunn", to: "Dalby", travelTrain: 1 },
    { from: "Dalby", to: "Kupunn", travelTrain: 1 },
    { from: "Jandowae", to: "Baign", travelTrain: 1 },
    { from: "Baign", to: "Jandowae", travelTrain: 1 },
    { from: "Baign", to: "Tycanba", travelTrain: 1 },
    { from: "Tycanba", to: "Baign", travelTrain: 1 },
    { from: "Miles", to: "Columboola", travelTrain: 22.5 },
    { from: "Columboola", to: "Miles", travelTrain: 22.5 },
    { from: "Columboola", to: "Rywung", travelTrain: 16.5 },
    { from: "Rywung", to: "Columboola", travelTrain: 16.5 },
    { from: "Rywung", to: "Chinchilla", travelTrain: 22.5 },
    { from: "Chinchilla", to: "Rywung", travelTrain: 22.5 },
    { from: "Miles", to: "Drillham", travelTrain: 27.5 },
    { from: "Drillham", to: "Miles", travelTrain: 27.5 },
    { from: "Drillham", to: "Ulimaroa", travelTrain: 9.5 },
    { from: "Ulimaroa", to: "Drillham", travelTrain: 9.5 },
    { from: "Ulimaroa", to: "Dulacca", travelTrain: 17.5 },
    { from: "Dulacca", to: "Ulimaroa", travelTrain: 17.5 },
    { from: "Dulacca", to: "Jackson", travelTrain: 18.5 },
    { from: "Jackson", to: "Dulacca", travelTrain: 18.5 },
    { from: "Jackson", to: "Yuleba", travelTrain: 30.5 },
    { from: "Yuleba", to: "Jackson", travelTrain: 30.5 },
    { from: "Yuleba", to: "Wallumbilla", travelTrain: 24.5 },
    { from: "Wallumbilla", to: "Yuleba", travelTrain: 24.5 },
    { from: "Wallumbilla", to: "Blythdale", travelTrain: 24.5 },
    { from: "Blythdale", to: "Wallumbilla", travelTrain: 24.5 },
    { from: "Blythdale", to: "Roma", travelTrain: 22.5 },
    { from: "Roma", to: "Blythdale", travelTrain: 22.5 },
    { from: "Miles", to: "Kowguran", travelTrain: 33.5 },
    { from: "Kowguran", to: "Miles", travelTrain: 33.5 },
    { from: "Kowguran", to: "Guluguba", travelTrain: 43.5 },
    { from: "Guluguba", to: "Kowguran", travelTrain: 43.5 },
    { from: "Guluguba", to: "Wandoan", travelTrain: 30.5 },
    { from: "Wandoan", to: "Guluguba", travelTrain: 30.5 },
    { from: "Mungallala", to: "Dubydilla", travelTrain: 23.5 },
    { from: "Dubydilla", to: "Mungallala", travelTrain: 23.5 },
    { from: "Dubydilla", to: "Morven", travelTrain: 29.5 },
    { from: "Morven", to: "Dubydilla", travelTrain: 29.5 },
    { from: "Morven", to: "Angellala", travelTrain: 26.5 },
    { from: "Angellala", to: "Morven", travelTrain: 26.5 },
    { from: "Angellala", to: "Sommariva", travelTrain: 34.5 },
    { from: "Sommariva", to: "Angellala", travelTrain: 34.5 },
    { from: "Sommariva", to: "Arabella", travelTrain: 20.5 },
    { from: "Arabella", to: "Sommariva", travelTrain: 20.5 },
    { from: "Arabella", to: "Charleville", travelTrain: 27.5 },
    { from: "Charleville", to: "Arabella", travelTrain: 27.5 },
    { from: "Mungallala", to: "Amboola", travelTrain: 27.5 },
    { from: "Amboola", to: "Mungallala", travelTrain: 27.5 },
    { from: "Amboola", to: "Womalilla", travelTrain: 16.5 },
    { from: "Womalilla", to: "Amboola", travelTrain: 16.5 },
    { from: "Womalilla", to: "Mitchell", travelTrain: 28.5 },
    { from: "Mitchell", to: "Womalilla", travelTrain: 28.5 },
    { from: "Mitchell", to: "Bongo", travelTrain: 25.5 },
    { from: "Bongo", to: "Mitchell", travelTrain: 25.5 },
    { from: "Bongo", to: "Amby", travelTrain: 7.5 },
    { from: "Amby", to: "Bongo", travelTrain: 7.5 },
    { from: "Amby", to: "Muckadilla", travelTrain: 27.5 },
    { from: "Muckadilla", to: "Amby", travelTrain: 27.5 },
    { from: "Muckadilla", to: "Hodgson", travelTrain: 27.5 },
    { from: "Hodgson", to: "Muckadilla", travelTrain: 27.5 },
    { from: "Hodgson", to: "Roma", travelTrain: 34.5 },
    { from: "Roma", to: "Hodgson", travelTrain: 34.5 },
    { from: "Oakey", to: "Jordanyan Coal Siding", travelTrain: 18.5 },
    { from: "Jordanyan Coal Siding", to: "Oakey", travelTrain: 18.5 },
    { from: "Jordanyan Coal Siding", to: "Malu", travelTrain: 6.5 },
    { from: "Malu", to: "Jordanyan Coal Siding", travelTrain: 6.5 },
    { from: "Malu", to: "Bowenville", travelTrain: 12.5 },
    { from: "Bowenville", to: "Malu", travelTrain: 12.5 },
    { from: "Bowenville", to: "Koomi", travelTrain: 14.5 },
    { from: "Koomi", to: "Bowenville", travelTrain: 14.5 },
    { from: "Koomi", to: "Blaxland", travelTrain: 15.5 },
    { from: "Blaxland", to: "Koomi", travelTrain: 15.5 },
    { from: "Blaxland", to: "Dalby", travelTrain: 12.5 },
    { from: "Dalby", to: "Blaxland", travelTrain: 12.5 },
    { from: "Oakey", to: "Kingsthorpe", travelTrain: 17.5 },
    { from: "Kingsthorpe", to: "Oakey", travelTrain: 17.5 },
    { from: "Kingsthorpe", to: "Gowrie", travelTrain: 17.5 },
    { from: "Gowrie", to: "Kingsthorpe", travelTrain: 17.5 },
    { from: "Gowrie", to: "Willowburn", travelTrain: 22.5 },
    { from: "Willowburn", to: "Gowrie", travelTrain: 22.5 },
    { from: "Willowburn", to: "Toowoomba", travelTrain: 10 },
    { from: "Toowoomba", to: "Willowburn", travelTrain: 10 },
    { from: "Quilpie", to: "Coolbinga", travelTrain: 57.5 },
    { from: "Coolbinga", to: "Quilpie", travelTrain: 57.5 },
    { from: "Coolbinga", to: "Cheepie", travelTrain: 72.5 },
    { from: "Cheepie", to: "Coolbinga", travelTrain: 72.5 },
    { from: "Cheepie", to: "Cooladdi", travelTrain: 77.5 },
    { from: "Cooladdi", to: "Cheepie", travelTrain: 77.5 },
    { from: "Roma", to: "Blythdale", travelTrain: 22.5 },
    { from: "Blythdale", to: "Roma", travelTrain: 22.5 },
    { from: "Blythdale", to: "Wallumbilla", travelTrain: 24.5 },
    { from: "Wallumbilla", to: "Blythdale", travelTrain: 24.5 },
    { from: "Wallumbilla", to: "Yuleba", travelTrain: 24.5 },
    { from: "Yuleba", to: "Wallumbilla", travelTrain: 24.5 },
    { from: "Yuleba", to: "Jackson", travelTrain: 28.5 },
    { from: "Jackson", to: "Yuleba", travelTrain: 28.5 },
    { from: "Jackson", to: "Dulacca", travelTrain: 16.5 },
    { from: "Dulacca", to: "Jackson", travelTrain: 16.5 },
    { from: "Coolbinga", to: "Cheepie", travelTrain: 72.5 },
    { from: "Cheepie", to: "Coolbinga", travelTrain: 72.5 },
    { from: "Cheepie", to: "Cooladdi", travelTrain: 77.5 },
    { from: "Cooladdi", to: "Cheepie", travelTrain: 77.5 },
    ...
    { from: "Jackson", to: "Dulacca", travelTrain: 16.5 },
    { from: "Dulacca", to: "Jackson", travelTrain: 16.5 },
    { from: "Dulacca", to: "Ulimaroa", travelTrain: 22.5 },
    { from: "Ulimaroa", to: "Dulacca", travelTrain: 22.5 },
    { from: "Ulimaroa", to: "Drillham", travelTrain: 7.5 },
    { from: "Drillham", to: "Ulimaroa", travelTrain: 7.5 },
    { from: "Drillham", to: "Miles", travelTrain: 24.5 },
    { from: "Miles", to: "Drillham", travelTrain: 24.5 },
    { from: "Roma", to: "Hodgson", travelTrain: 25.5 },
    { from: "Hodgson", to: "Roma", travelTrain: 25.5 },
    { from: "Hodgson", to: "Muckadilla", travelTrain: 23.5 },
    { from: "Muckadilla", to: "Hodgson", travelTrain: 23.5 },
    { from: "Muckadilla", to: "Amby", travelTrain: 23.5 },
    { from: "Amby", to: "Muckadilla", travelTrain: 23.5 },
    { from: "Amby", to: "Bongo", travelTrain: 7.5 },
    { from: "Bongo", to: "Amby", travelTrain: 7.5 },
    { from: "Bongo", to: "Mitchell", travelTrain: 22.5 },
    { from: "Mitchell", to: "Bongo", travelTrain: 22.5 },
    { from: "Mitchell", to: "Womalilla", travelTrain: 36.5 },
    { from: "Womalilla", to: "Mitchell", travelTrain: 36.5 },
    { from: "Womalilla", to: "Amboola", travelTrain: 13.5 },
    { from: "Amboola", to: "Womalilla", travelTrain: 13.5 },
    { from: "Amboola", to: "Mungallala", travelTrain: 25.5 },
    { from: "Mungallala", to: "Amboola", travelTrain: 25.5 },
];
        ...
        while (queue.length && !found) {
            ...
            for (let next of SRT_DATA.filter((s) => s.from.trim().toLowerCase() === last.trim().toLowerCase() ||
                ...
                if (!visited.has(nextStop))
                    queue.push({ path: [...path, next], last: nextStop });
            }
        }
        if (found) {
            // Build a list of stops in order by traversing the path
            let stops = [from.PlaceName];

...
class Logger {
    ...
    formatLog(level, color, message, context, colorize = true) {
        ...
        const moduleStr = context?.module ? (colorize ? chalk.gray(`[m:${context.module}]`) : `[m:${context.module}]`) : '';
        const functionStr = context?.function ? (colorize ? chalk.gray(`[f:${context.function}]`) : `[f:${context.function}]`) : '';
